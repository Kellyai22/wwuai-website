...
- `hub.html` — The public links page, live at `/links` (restructured 2 June 2026, PR #3). Masterclass is the hero card at top → `/masterclass`; the retired standalone Skool-join card and the Hub Install card were removed. Keeps Free Tools, the Substack newsletter, and the $47 template. No longer routed to `/hub` (since 2026-05-02).
